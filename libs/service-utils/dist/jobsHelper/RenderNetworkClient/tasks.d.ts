import { ExportFilesPublishOptions, ExportFilesS3Options, ExportFilesSaveOptions, ExportFormat, Filename, PdfJobData, PngJobData, SvgJobData } from '../types';
...
export declare const createExportFileSaveTasks: (saveOptions: ExportFilesSaveOptions, filenames: Filename<ExportFormat>[]) => Task[];
